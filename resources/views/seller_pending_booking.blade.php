...
<section class="portfolio-detail">
      ...
      <div class="col-12 col-sm-4 myCard singleBookingCard singleBookingCardPen">
        ...
        <div class="b-desc">
          ...
          @if($bookingDatas['status']=="Pending")
            <a href="/acceptBooking/{{$bookingDatas->clint_id}}"><button href="" class="my-dbcard-btn ButtonAccept">Accept</button></a>
            <a href="/rejectBooking/{{$bookingDatas->clint_id}}"><button href="" class="my-dbcard-btn ButtonReject">Reject</button></a>
          @endif              
      </div>
            ...
            @else
            <h2>THERE IS NO PENDING REQUEST!</h2>
            @endif
         @endforeach
        </div>
      </div>
